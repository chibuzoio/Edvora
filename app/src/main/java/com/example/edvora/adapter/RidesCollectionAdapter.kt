...
class RidesCollectionAdapter(private val ridesCollectionArray: Array<RidesCollectionModel>) :
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        Glide.with(holder.itemView)
            .load(ridesCollectionArray[position].mapUrl)
        ...
        holder.binding.originStationTextView.text = holder.itemView.context.getString(R.string.origin_station).plus(ridesCollectionArray[position].originStationCode.toString())
        holder.binding.stationPathTextView.text = holder.itemView.context.getString(R.string.station_path).plus(ridesCollectionArray[position].stationPath.toString())
